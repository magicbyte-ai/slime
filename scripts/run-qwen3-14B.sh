...
CKPT_ARGS=(
   --hf-checkpoint ${MODEL_DIR}/Qwen3-14B
   #--hf-checkpoint /root/Qwen3-14B-FP8
   --ref-load ${MODEL_DIR}/Qwen3-14B_torch_dist
   --load ${MODEL_DIR}/Qwen3-14B_slime/
   --save ${MODEL_DIR}/Qwen3-14B_slime/
   --save-interval 50
)
